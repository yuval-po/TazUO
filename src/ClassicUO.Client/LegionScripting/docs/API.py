...
class LegionAPI(IDisposable):
    ...
    def ProcessCallbacks(self) -> None:
        """
    ...
    def OnHotKey(self, key: "str", callback: "Any" = None) -> None:
        """
    ...
    def SetSharedVar(self, name: "str", value: "Any") -> None:
        """
    ...
    def GetSharedVar(self, name: "str") -> "Any":
        """
    ...
    def RemoveSharedVar(self, name: "str") -> None:
        """
    ...
    def SetWarMode(self, enabled: "bool") -> None:
        """
    ...
    def ClearRightHand(self) -> "PyItem":
        """
    ...
    def ClickObject(self, serial: "int") -> None:
        """
    ...
    def UseObject(self, serial: "int", skipQueue: "bool" = True) -> None:
        """
    ...
    def Contents(self, serial: "int") -> "int":
        """
    ...
    def ContextMenu(self, serial: "int", entry: "int") -> None:
        """
    ...
    def MenuResponseCurrent(self, index: "int", itemGraphic: "int" = 0, itemHue: "int" = 0) -> "bool":
        """
    ...
    def MenuItemsCurrent(self) -> "list":
        """
    ...
    def GrayMenuResponseCurrent(self, index: "int") -> "bool":
        """
    ...
    def QueueMoveItem(self, serial: "int", destination: "int", amt: "int" = 0, x: "int" = 0xFFFF, y: "int" = 0xFFFF) -> None:
        """
    ...
    def MoveItem(self, serial: "int", destination: "int", amt: "int" = 0, x: "int" = 0xFFFF, y: "int" = 0xFFFF) -> None:
        """
         Move an item to another container.
         Use x, and y if you don't want items stacking in the desination container.
         Example:
    ...
    def QueueMoveItemOffset(self, serial: "int", amt: "int" = 0, x: "int" = 0, y: "int" = 0, z: "int" = 0, OSI: "bool" = False) -> None:
        """
    ...
    def MoveItemOffset(self, serial: "int", amt: "int" = 0, x: "int" = 0, y: "int" = 0, z: "int" = 0, OSI: "bool" = False) -> None:
        """
         Move an item to the ground near you.
         Example:
         ```py
    ...
    def UseSkill(self, skillName: "str") -> None:
        """
         Use a skill.
         Example:
         ```py
    ...
    def CastSpell(self, spellName: "str") -> None:
        """
    ...
    def Undress(self, name: "str") -> None:
        """
    ...
    def UndressAll(self, kr: "bool" = False) -> None:
        """
    ...
    def GetAvailableDressOutfits(self) -> "list":
        """
    ...
    def Organizer(self, name: "str", source: "int" = 0, destination: "int" = 0) -> None:
        """
    ...
    def ClientCommand(self, command: "str") -> None:
        """
    ...
    def BuffExists(self, buffName: "str") -> "bool":
        """
    ...
    def ActiveBuffs(self) -> "list[Buff]":
        """
    ...
    def SysMsg(self, message: "str", hue: "int" = 946) -> None:
        """
    ...
    def HeadMsg(self, message: "str", serial: "int", hue: "int" = 1337) -> None:
        """
    ...
    def PartyMsg(self, message: "str") -> None:
        """
    ...
    def GuildMsg(self, message: "str") -> None:
        """
    ...
    def AllyMsg(self, message: "str") -> None:
        """
    ...
    def WhisperMsg(self, message: "str") -> None:
        """
         Whisper a message.
         Example:
         ```py
    ...
    def YellMsg(self, message: "str") -> None:
        """
         Yell a message.
         Example:
         ```py
    ...
    def EmoteMsg(self, message: "str") -> None:
        """
         Emote a message.
         Example:
         ```py
    ...
    def GlobalMsg(self, message: "str") -> None:
        """
    ...
    def PromptResponse(self, message: "str") -> None:
        """
    ...
    def FindItem(self, serial: "int") -> "PyItem":
        """
    ...
    def FindType(self, graphic: "int", container: "int" = 1337, range: "int" = 1337, hue: "int" = 1337, minamount: "int" = 0) -> "PyItem":
        """
    ...
    def FindTypeAll(self, graphic: "int", container: "int" = 1337, range: "int" = 1337, hue: "int" = 1337, minamount: "int" = 0) -> "list[PyItem]":
        """
    ...
    def FindLayer(self, layer: "str", serial: "int" = 1337) -> "PyItem":
        """
    ...
    def GetItemsOnGround(self, distance: "int" = int.MaxValue, graphic: "int" = 1337) -> "list":
        """
    ...
    def ItemsInContainer(self, container: "int", recursive: "bool" = False) -> "list[PyItem]":
        """
    ...
    def UseType(self, graphic: "int", hue: "int" = 1337, container: "int" = 1337, skipQueue: "bool" = True) -> None:
        """
    ...
    def CreateCooldownBar(self, seconds: "float", text: "str", hue: "int") -> None:
        """
    ...
    def IgnoreObject(self, serial: "int") -> None:
        """
    ...
    def UnIgnoreObject(self, serial: "int") -> None:
        """
    ...
    def OnIgnoreList(self, serial: "int") -> "bool":
        """
    ...
    def Pathfind(self, x: "int", y: "int", z: "int" = 1337, distance: "int" = 1, wait: "bool" = False, timeout: "int" = 10) -> "bool":
        """
    ...
    def PathfindEntity(self, entity: "int", distance: "int" = 1, wait: "bool" = False, timeout: "int" = 10) -> "bool":
        """
    ...
    def CancelPathfinding(self) -> None:
        """
         Cancel pathfinding.
         Example:
         ```py
    ...
    def GetPath(self, x: "int", y: "int", z: "int" = 1337, distance: "int" = 1) -> "list":
        """
    ...
    def AutoFollow(self, mobile: "int") -> None:
        """
    ...
    def CancelAutoFollow(self) -> None:
        """
    ...
    def Rename(self, serial: "int", name: "str") -> None:
        """
    ...
    def Dismount(self, skipQueue: "bool" = True) -> None:
        """
    ...
    def Mount(self, serial: "int" = 1337, skipQueue: "bool" = True) -> None:
        """
    ...
    def SetMount(self, serial: "int") -> None:
        """
    ...
    def WaitForTarget(self, targetType: "str" = "any", timeout: "float" = 5) -> "bool":
        """
    ...
    def Target(self, serial: "int") -> None:
        """
    ...
    def Target(self, x: "int", y: "int", z: "int", graphic: "int" = 1337) -> None:
        """
    ...
    def RequestTarget(self, timeout: "float" = 5) -> "int":
        """
    ...
    def RequestAnyTarget(self, timeout: "float" = 5) -> "PyGameObject":
        """
    ...
    def TargetLandRel(self, xOffset: "int", yOffset: "int") -> None:
        """
    ...
    def TargetTileRel(self, xOffset: "int", yOffset: "int", graphic: "int" = 1337) -> None:
        """
    ...
    def TargetResource(self, itemSerial: "int", resource: "int") -> None:
        """
    ...
    def PreTarget(self, serial: "int", targetType: "str" = "neutral") -> None:
        """
    ...
    def HasTarget(self, targetType: "str" = "any") -> "bool":
        """
    ...
    def SetSkillLock(self, skill: "str", up_down_locked: "str") -> None:
        """
    ...
    def SetStatLock(self, stat: "str", up_down_locked: "str") -> None:
        """
         Set a skills lock status.
         Example:
         ```py
    ...
    def ItemNameAndProps(self, serial: "int", wait: "bool" = False, timeout: "int" = 10) -> "str":
        """
    ...
    def RequestOPLData(self, serials: "list[int]") -> None:
        """
    ...
    def HasGump(self, ID: "int" = 1337) -> "int":
        """
    ...
    def ReplyGump(self, button: "int", gump: "int" = 1337, switches: "list[int]" = None) -> "bool":
        """
         Reply to a gump.
         Example:
         ```py
    ...
    def CloseGump(self, ID: "int" = 1337) -> "bool":
        """
    ...
    def ConfigNextGump(self, serial: "int | None" = None, x: "int | None" = None, y: "int | None" = None, isVisible: "bool | None" = None, autoClose: "bool | None" = None, autoRespond: "bool | None" = None, autoRespondButton: "int | None" = None) -> None:
        """
    ...
    def GumpContains(self, text: "str", ID: "int" = 1337) -> "bool":
        """
    ...
    def GetGumpContents(self, ID: "int" = 1337) -> "str":
        """
    ...
    def GetGump(self, ID: "int" = 1337) -> "PyBaseGump":
        """
         Get a gump by ID.
         Example:
         ```py
    ...
    def WaitForGump(self, ID: "int" = 1337, delay: "float" = 5) -> "bool":
        """
    ...
    def CloseContextMenus(self) -> None:
        """
    ...
    def ToggleAbility(self, ability: "str") -> None:
        """
         Toggle an ability.
         Example:
         ```py
    ...
    def PrimaryAbilityActive(self) -> "bool":
        """
    ...
    def SecondaryAbilityActive(self) -> "bool":
        """
    ...
    def CurrentAbilityNames(self) -> "list[str]":
        """
    ...
    def KnownAbilityNames(self) -> "list[str]":
        """
    ...
    def InJournal(self, msg: "str", clearMatches: "bool" = False) -> "bool":
        """
    ...
    def InJournalAny(self, msgs: "list[str]", clearMatches: "bool" = False) -> "bool":
        """
    ...
    def GetJournalEntries(self, seconds: "float", matchingText: "str" = "") -> "list":
        """
    ...
    def ClearJournal(self, matchingEntries: "str" = "") -> None:
        """
    ...
    def AutoLootContainer(self, container: "int") -> None:
        """
    ...
    def Virtue(self, virtue: "str") -> None:
        """
         Use a virtue.
         Example:
         ```py
    ...
    def NearestEntity(self, scanType: "ScanType", maxDistance: "int" = 10) -> "Any":
        """
    ...
    def NearestMobile(self, notoriety: "list[Notoriety]", maxDistance: "int" = 10) -> "PyMobile":
        """
    ...
    def NearestCorpse(self, distance: "int" = 3) -> "PyItem":
        """
    ...
    def NearestMobiles(self, notoriety: "list[Notoriety]", maxDistance: "int" = 10) -> "list[PyMobile]":
        """
    ...
    def FindMobile(self, serial: "int") -> "PyMobile":
        """
    ...
    def GetAllMobiles(self, graphic: "int | None" = None, distance: "int | None" = None, notoriety: "list[Notoriety]" = None) -> "list[PyMobile]":
        """
    ...
    def GetTile(self, x: "int", y: "int") -> "PyGameObject":
        """
    ...
    def GetStaticsAt(self, x: "int", y: "int") -> "list[Any]":
        """
    ...
    def GetStaticsInArea(self, x1: "int", y1: "int", x2: "int", y2: "int") -> "list[Any]":
        """
    ...
    def GetMultisAt(self, x: "int", y: "int") -> "list[Any]":
        """
    ...
    def GetMultisInArea(self, x1: "int", y1: "int", x2: "int", y2: "int") -> "list[Any]":
        """
    ...
    def IsFriend(self, serial: "int") -> "bool":
        """
    ...
    def AddFriend(self, serial: "int") -> "bool":
        """
    ...
    def RemoveFriend(self, serial: "int") -> "bool":
        """
    ...
    def GetPartyMemberSerials(self) -> "list":
        """
    ...
    def GetSkill(self, skill: "str") -> "Skill":
        """
    ...
    def DisplayRange(self, distance: "int", hue: "int" = 22) -> None:
        """
    ...
    def ToggleScript(self, scriptName: "str") -> None:
        """
    ...
    def PlayScript(self, scriptName: "str") -> None:
        """
    ...
    def StopScript(self, scriptName: "str") -> None:
        """
    ...
    def AddMapMarker(self, name: "str", x: "int" = int.MaxValue, y: "int" = int.MaxValue, map: "int" = int.MaxValue, color: "str" = "purple") -> None:
        """
    ...
    def RemoveMapMarker(self, name: "str") -> None:
        """
    ...
    def IsProcessingMoveQueue(self) -> "bool":
        """
    ...
    def IsProcessingUseItemQueue(self) -> "bool":
        """
    ...
    def IsGlobalCooldownActive(self) -> "bool":
        """
    ...
    def SavePersistentVar(self, name: "str", value: "str", scope: "Any") -> None:
        """
    ...
    def RemovePersistentVar(self, name: "str", scope: "Any") -> None:
        """
    ...
    def GetPersistentVar(self, name: "str", defaultValue: "str", scope: "Any") -> "str":
        """
    ...
    def MarkTile(self, x: "int", y: "int", hue: "int", map: "int" = -1) -> None:
        """
    ...
    def RemoveMarkedTile(self, x: "int", y: "int", map: "int" = -1) -> None:
        """
    ...
    def TrackingArrow(self, x: "int", y: "int", identifier: "int" = 1337) -> None:
        """
